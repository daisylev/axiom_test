Feature: Axiom test
    ...
    Scenario: Webapp user flow
        ...
        And Verify "Created by" on Details session is "approver@quynhle.com"
        ...
        And Verify Actor on Events session is "approver@quynhle.com"
        ...
        And User can see "Access Request Details" page
        ...
        Given Wait for loading icon disappears
        Then Verify Status of created Request is "APPROVED" at index "1"
